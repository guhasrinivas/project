...
module.exports.createListing=async (req, res, next) => {
    // so here instead of this if conditions we can use joi validation so created a schema.js file
    //then creating a function validateListing and passing it as middleware
